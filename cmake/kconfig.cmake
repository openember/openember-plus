...
set(BOARD_DEFCONFIG ${BOARD_DIR}/test_defconfig)
...
set(EXTRA_KCONFIG_TARGET_COMMAND_FOR_menuconfig
  ${PROJECT_ROOT}/tools/kconfig/menuconfig.py
  )

set(EXTRA_KCONFIG_TARGET_COMMAND_FOR_guiconfig
  ${PROJECT_ROOT}/tools/kconfig/guiconfig.py
  )

set(EXTRA_KCONFIG_TARGET_COMMAND_FOR_hardenconfig
  ${PROJECT_ROOT}/tools/kconfig/hardenconfig.py
  )
...
message(
  ${PYTHON_EXECUTABLE}
  ${PROJECT_ROOT}/tools/kconfig/kconfig.py
